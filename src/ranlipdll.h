...
// from a DLL simpler. All files within this DLL are compiled with the RANLIPDLL_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// RANLIPDLL_API functions as being imported from a DLL, wheras this DLL sees symbols
// defined with this macro as being exported.
#ifdef RANLIPDLL_EXPORTS
#define RANLIPDLL_API __declspec(dllexport)
#else
#define RANLIPDLL_API __declspec(dllimport)
#endif


// This class is exported from the ranlipdll.dll
class RANLIPDLL_API CRanLip {
public:
	CRanLip(void);
...
class RANLIPDLL_API ProcRanLip:public CRanLip {
	 public: virtual double	Distribution(double* p) ;
...
extern RANLIPDLL_API ProcRanLip RanLipGenerator;
...
// initialises the tables and arrays for the generator
// should be the first method to call
RANLIPDLL_API	void InitRanLip(int dim, double* left, double* right);
...
// numfine is the number of cells in the fine partition. Should be a power of 2
// to speed up calculations
RANLIPDLL_API	void PrepareHatFunctionRanLip(int num, int numfine, double Lip);

// computes the hat function, and automatically computes the Lipschitz constant
RANLIPDLL_API	void PrepareHatFunctionAutoRanLip(int num, int numfine, double minLip=0);

// generates a random variate with the required density
RANLIPDLL_API	void RandomVecRanLip(double* p);

// saves the computed hat function into a file
RANLIPDLL_API	void	SavePartitionRanlip(char * fname);

// loads the hat function from the file
RANLIPDLL_API	void	LoadPartitionRanLip(char * fname);

// to free memory occupied by the generator
RANLIPDLL_API	void FreeMemRanLip();

// sets the pointer to the uniform random number generator. The default is
// M. Luescher's ranlux generator (see gsl_randist.h)
RANLIPDLL_API	void SetUniformGeneratorRanLip( UFunction gen  );

// sets the seed for the uniform random number generator
RANLIPDLL_API   void SeedRanLip(int seed);

// gets the seed used for the uniform random number generator
RANLIPDLL_API   int GetSeedRanLip();

// returns Lipschitz constant computed by PrepareHatFunctionAutoRanLip
RANLIPDLL_API    double LipschitzRanLip();
 
// returns the total number of generated random variates (accepted and rejected)
RANLIPDLL_API    long int Count_totalRanLip();
...
RANLIPDLL_API    long int Count_errorRanLip();

RANLIPDLL_API     void SetDistFunctionRanLip(DistFun dist);
